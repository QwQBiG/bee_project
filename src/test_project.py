...
def test_project_structure():
    ...
    for dir_name in source_dirs:
        ...
        if dir_path.exists():
            print(f"  [OK] 源码目录存在: src/{dir_name}/")
        else:
            print(f"  [WARN] 源码目录缺失: src/{dir_name}/")

    for dir_name in root_dirs:
        dir_path = project_root / dir_name
        if dir_path.exists():
            print(f"  [OK] 顶层目录存在: {dir_name}/")
        else:
            print(f"  [WARN] 顶层目录缺失: {dir_name}/")
...
def test_code_files():
    ...
    code_files = [
        ...
        'tools/inspect_oist_annotations.py',
...
def test_function_signatures():
    ...
    key_functions = {
        ...
        'tools/inspect_oist_annotations.py': ['parse_annotation_file', 'summarize'],
