...
```bat
py -3.13 src\main.py --help
py -3.13 src\main.py --mode outside --video "data\outside.mp4" --output "output\outside"
py -3.13 src\main.py --mode inside --video "data\inside.mp4" --output "output\inside"
```
