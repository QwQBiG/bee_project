...
class OutsideHiveBeeDetector:
    ...
    def __init__(self, model_path: str = "weights/hive_entrance_bee_yolov8n.onnx",
...
class OutsideHiveTracker:
    ...
    def __init__(self, config: Dict):
        ...
        self.detector = OutsideHiveBeeDetector(
            model_path=config.get('model_path', 'weights/hive_entrance_bee_yolov8n.onnx'),
