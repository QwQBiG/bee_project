...
class InsideHiveBeeDetector:
    ...
    def __init__(self, model_path: str = "weights/bee_inside_ft_v1.onnx",
...
class InsideHiveTracker:
    ...
    def __init__(self, config: Dict):
        ...
        self.detector = InsideHiveBeeDetector(
            model_path=config.get('model_path', 'weights/bee_inside_ft_v1.onnx'),
