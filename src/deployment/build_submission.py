...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--runner", default=str(SOURCE_ROOT / "deployment" / "competition_runner.py"))
    parser.add_argument(
        "--weights", default=str(PROJECT_ROOT / "weights"))
    parser.add_argument(
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    print("run src/make_selfcheck.py, src/validate_package.py, then src/rezip_after_selfcheck.py")
    return 0
