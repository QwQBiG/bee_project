...
def load_predictions(split):
    ...
    digest = hashlib.sha256((ROOT / "weights/hive_entrance_bee_yolov8n.onnx").read_bytes()).hexdigest()
...
def main():
    ...
    capture = cv2.VideoCapture(str(SOURCE_ROOT / "data/external/vnbee/2022-04-08-12-30.mp4"))
