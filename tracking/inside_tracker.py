...
class InsideHiveBeeDetector:
    ...
    def __init__(self, model_path: str = "artifacts/models/bee_inside_ft_v1.onnx",
...
class InsideHiveTracker:
    ...
    def __init__(self, config: Dict):
        ...
        self.detector = InsideHiveBeeDetector(
            model_path=config.get('model_path', 'artifacts/models/bee_inside_ft_v1.onnx'),
...
def create_inside_tracker(config: Dict = None) -> InsideHiveTracker:
    ...
    if config is None:
        config = {
            'model_path': 'artifacts/models/bee_inside_ft_v1.onnx',
            'conf_threshold': 0.2,
            'iou_threshold': 0.45,
            'device': None,
